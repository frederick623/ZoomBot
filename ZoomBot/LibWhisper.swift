...
actor WhisperContext {
    ...
    init(context: OpaquePointer, language: String = "yue") {
    ...
    func benchFull(modelName: String, nThreads: Int32) async -> String {
        ...
        let systemName = "macOS \(ProcessInfo.processInfo.operatingSystemVersionString)"
#endif
    ...
    static func createContext(path: String, language: String = "yue") throws -> WhisperContext {
        ...
        if let context {
            return WhisperContext(context: context, language: language)
        } else {
